...
\caption{Summary of models; their predictors, covariates and variable interactions.}\label{tab:tab1}
  \resizebox{\textwidth}{!}{\begin{tabular}{@{}ccccc@{}}
    ...
    \textbf{Model 4} & ${\textrm{Yield} \times \textrm{Average Sale Price}}\over{\textrm{Area Harvested}}$ & \begin{tabular}[c]{@{}c@{}}Water Used\\ Scope One Emissions\end{tabular} & \begin{tabular}[c]{@{}c@{}}Area Harvested\\
        ...
        \\
        \multicolumn{1}{l}{} & \multicolumn{1}{l}{} & \multicolumn{1}{l}{} & \multicolumn{1}{l}{} & \multicolumn{1}{l}{} \\
     \textbf{Model 5} & ${\textrm{Yield} \times \textrm{Average Sale Price}}\over{\textrm{Area Harvested}}$ & \begin{tabular}[c]{@{}c@{}}Water Used\\ Scope One Emissions\end{tabular} & \begin{tabular}[c]{@{}c@{}} Year\\ GI Region\end{tabular} & \begin{tabular}[c]{@{}c@{}} Year * Region\end{tabular}
        \end{tabular}}
\end{table}
  ...
  \caption{Pairwise Pearson correlation coefficients for logarithmically transformed values.}\label{tab:pearson_correlation}
      \resizebox{\textwidth}{!}{
        \begin{tabular}{@{}cccccccc@{}}
          \toprule
          \textbf{} & \textbf{Yield} & \textbf{Area Harvested} & \textbf{Water Used} & \textbf{\begin{tabular}[c]{@{}c@{}}Scope One\\ Emissions\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Yield by\\ Area\end{tabular}} & \textbf{Average Price} & \textbf{\begin{tabular}[c]{@{}c@{}}Average Price\\ by Area\end{tabular}} \\ \midrule
          Yield & 1.00 & 0.75 & 0.00 & 0.72 & 0.35 & 0.40 & -0.23 \\
          Area Harvested & 0.75 & 1.00 & -0.01 & 0.88 & 0.09 & 0.86 & -0.13 \\
          Water Used & 0.00 & -0.01 & 1.00 & 0.00 & -0.01 & 0.05 & -0.03 \\
          \begin{tabular}[c]{@{}c@{}}Scope One\\ Emissions\end{tabular} & 0.72 & 0.88 & 0.00 & 1.00 & 0.10 & 0.75 & -0.10 \\
          \begin{tabular}[c]{@{}c@{}}Yield by\\ Area\end{tabular} & 0.35 & 0.09 & -0.01 & 0.10 & 1.00 & -0.09 & -0.48 \\
          Average Price & 0.40 & 0.86 & 0.05 & 0.75 & -0.09 & 1.00 & 0.07 \\
          \begin{tabular}[c]{@{}c@{}}Average Price\\ by Area\end{tabular} & -0.23 & -0.13 & -0.03 & -0.10 & -0.48 & 0.07 & 1.00 \\ \bottomrule
          \end{tabular}
}
\end{table}
